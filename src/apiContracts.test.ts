...
describe("api contracts", () => {
  ...
  it("summarizes API readiness from provider, runtime, and mobile contracts", () => {
    ...
    expect(summary.providers.total).toBeGreaterThanOrEqual(80);
    expect(summary.providers.credentialGated).toBeGreaterThanOrEqual(50);
    expect(summary.runtime.localReady).toBeGreaterThanOrEqual(15);
  ...
  it("builds bootstrap payloads for customer, admin, and mobile clients", () => {
    ...
    expect(payload.admin.coverage.total).toBeGreaterThanOrEqual(80);
