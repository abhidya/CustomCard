...
export const localizationBundles: Record<SupportedLocaleCode, Record<LocalizationMessageKey, string>> = {
  ...
  "es-US": {
    ...
    renderChoices: "Opciones de render",
    manualHandoff: "Entrega manual",
    realOrdersDisabled: "Pedidos reales desactivados",
  ...
  "ur-PK": {
    ...
    renderChoices: "Render choices - Urdu review",
    manualHandoff: "Manual handoff - Urdu review",
    realOrdersDisabled: "Real orders disabled",
    sourceBackedPricing: "Source-backed pricing",
  ...
  "ar-EG": {
    ...
    renderChoices: "Render choices - Arabic review",
    manualHandoff: "Manual handoff - Arabic review",
    realOrdersDisabled: "Real orders disabled",
    sourceBackedPricing: "Source-backed pricing",
