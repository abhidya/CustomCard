...
export const hostedApiReadinessItems = [
  ...
  },
  {
    ...
    requiredSourceSignals: ["api/[...path].js", "api/robots.js", "scripts/vercel-api-delegate.mjs", "delegateApiRequest", "handleApiRequest", "vercel.json", '"source": "/oauth/callback"', "CUSTOMCARD_API_RUNTIME"],
    requiresHostedDb: false,
    requiresPublicRouteProof: false,
    requiresHostedTokenVerification: false,
    requiresBackupPolicy: false,
