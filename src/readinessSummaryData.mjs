...
export const readinessDomainDefinitions = [
  domain({
    ...
    validateSummary: (summary) => [
      ...
      ...minimum(summary, "localFallbacks", 2, "AI provider readiness must keep local fallbacks."),
  ...
  domain({
    ...
    validateSummary: (summary) => [
      ...
      ...zero(summary, "hostedDbProofs", "Hosted API readiness cannot claim hosted DB connectivity."),
      ...zero(summary, "publicRouteProofs", "Hosted API readiness cannot claim public DB-backed route proof."),
      ...
      ...zero(summary, "deploymentProtectionBypasses", "Hosted API readiness cannot claim deployment protection bypass proof."),
