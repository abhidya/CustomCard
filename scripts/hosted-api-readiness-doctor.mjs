...
const checks = [
  ...
  checkDoctorSourceSignals(doctorManifest, contents, {
    ...
    sourceKeys: ["envExample", "postgresHttpDoctor", "accountDoctor", "hostedReadinessData", "verificationDocs", "hostedVercelEnvInventory", "hostedVercelEnvRepair"],
    signals: [
  ...
  checkDoctorSourceSignals(doctorManifest, contents, {
    ...
    signals: [
      ...
      "--confirm-hosted-clerk-public-config-probe",
  ...
  checkDoctorSourceSignals(doctorManifest, contents, {
    ...
    sourceKeys: ["packageJson", "hostedReadinessData", "verificationDocs", "hostedMutationAuditProbe", "readinessTest"],
    signals: [
      '"hosted:mutation:probe": "node scripts/hosted-mutation-audit-probe.mjs"',
      "customcard-hosted-mutation-audit-probe",
      "npm run hosted:mutation:probe -- --confirm-hosted-mutation-probe",
      "npm run hosted:mutation:probe -- --confirm-hosted-mutation-probe --acknowledge-live-writes",
      "CUSTOMCARD_HOSTED_CUSTOMER_JWT",
      "CUSTOMCARD_HOSTED_ADMIN_JWT",
      "/api/render-packets",
