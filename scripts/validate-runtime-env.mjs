const requiredEnv = ["DATABASE_URL", "QUEUE_URL", "OBJECT_STORE_URL", "REAL_ORDER_KILL_SWITCH"];
...
console.log(JSON.stringify({ service: "customcard-runtime-doctor", status: "ready" }));
