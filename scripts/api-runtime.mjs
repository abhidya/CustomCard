...
import { persistGeneratedImageArtifacts } from "./generated-image-artifacts.mjs";

export { postgresPoolConfig } from "./postgres-runtime.mjs";
export { persistGeneratedImageArtifacts } from "./generated-image-artifacts.mjs";
...
function createPostgresApiRuntime({ env, routes, postgresPoolFactory, objectStoreRuntime }) {
  ...
  return {
    ...
    async renewProviderJobLease(input = {}) {
      return providerJobRuntime.renewJobLease(input);
    },
