...
const checks = [
  ...
  checkExact("register", "crm-adapter-contract-count", summary.crmAdapterContracts, 7),
  checkExact("register", "workflow-adapter-contract-count", summary.workflowAdapterContracts, 8),
  checkExact("register", "notification-adapter-contract-count", summary.notificationAdapterContracts, 10),
