...
- CI workflow runs full repository check, deployment doctor, contract API
  ...
  integration doctor, persistence doctor, worker readiness, and mobile doctor
...
- No deployed production Postgres API integration, production account auth flow,
  or account recovery; fake-pool and isolated live Postgres migration/runtime
  doctors cover the current API persistence boundary.
