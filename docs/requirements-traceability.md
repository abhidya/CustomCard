...
- Account auth doctor applies the committed migration to an isolated database,
  ...
  appends audit.
- Persistence contracts map 14 schema-backed API routes to auth-session,
