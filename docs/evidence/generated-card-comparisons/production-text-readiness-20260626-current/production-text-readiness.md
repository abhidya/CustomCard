...
Created: 2026-06-26T23:10:59.401Z
Status: blocked
Promotion ready: no
...
| configured production planner endpoint is reachable | yes | fail | {"configuredPlannerUrls":[],"discoveryMode":true,"activePlannerEndpoints":[{"baseUrl":"http://127.0.0.1:5001/v1","reachable":false,"activeModel":"","models":[],"smallPlanner":false,"productionSuitable":false,"error":"fetch failed"},{"baseUrl":"http://127.0.0.1:5003/v1","reachable":false,"activeModel":"","models":[],"smallPlanner":false,"productionSuitable":false,"error":"fetch failed"}]} |
...
| --- | --- | --- | --- |
| http://127.0.0.1:5001/v1 | no | fetch failed | no |
...
- Run tools/start-local-card-planner.ps1 with 8192+ context and GPU/offload, use a hosted/self-hosted production planner, or point -LocalLlmBaseUrl at that endpoint.
