...
Created: 2026-06-27T00:28:38.894Z
Status: blocked
Promotion ready: no

## Source Reports

- Evidence index: [open](../production-text-evidence-index-20260627-current/production-text-evidence-index.json)
- Promotion gate: [open](../production-text-promotion-gate-20260627-current/production-text-promotion-gate.json)
- Rerun plan: [open](../production-text-rerun-plan-20260627-current/production-text-rerun-plan.json)

## Findings

- Latest planner preflight is blocked: production-suitable model koboldcpp/gemma-4-31B-it-Q4_K_M.
...
- Production planner endpoint is not reachable for koboldcpp/gemma-4-31B-it-Q4_K_M (production-suitable); latest blocker: Planner /models preflight failed: fetch failed.
...
- Promotion gate currently fails 10 requirement(s): live ComfyUI preflight passed, live ComfyUI proof is current, planner preflight is production-ready, readiness doctor is promotion-ready, production-suitable planner endpoint is reachable, no small smoke planner is active or used, LLM-planned customer request matrix completed, planner preserved required terms and avoided forbidden terms, manual grade checklist is promotion-ready, manual aggregate is promotion-ready.

## Evidence Summary

| Area | Status | Key result | Path |
| --- | --- | --- | --- |
| Comfy text composer | blocked | comfy=no node=no | [open](../production-text-preflight-20260627-current/production-text-preflight.json) |
| Planner | blocked | production-suitable koboldcpp/gemma-4-31B-it-Q4_K_M; context=8192; max=3200 | [open](../production-text-planner-preflight-20260627-current/production-text-planner-preflight.json) |
| Readiness | blocked | production planner reachable=no; blockers=5 | [open](../production-text-readiness-20260627-current/production-text-readiness.json) |
...
- Run production-text preflight with live Comfy and CustomCardTextComposer loaded.
