...
Created: 2026-06-27T00:14:02.518Z
Local model root: `D:\models`
ComfyUI model root: `D:\ComfyUI-Easy-Install\ComfyUI-Easy-Install\ComfyUI\models`

## Summary

- Installed model/runtime files: 47
- Benchmark entries scanned: 241
- Local benchmark entries scanned: 17
- Evaluated text model ids: 9
- Evaluated image model ids: 13
- Locally evaluated text model ids: 2
- Locally evaluated image model ids: 2
- Installed files matched to local benchmark results: 3
- Recommended models installed: 9
- Recommended models locally evaluated: 3
- Recommended models missing: 1
...
| qwen3-14b-instruct | minimum local production-floor planner beneath Gemma 31B quality | no | no | no | Qwen/Qwen3-14B-GGUF, Q4_K_M | Pull Qwen3 14B if Gemma 31B is too slow for routine benchmark loops; keep Qwen3 8B as smoke-only evidence. |
| sdxl-base-or-card-checkpoint | production-oriented ComfyUI image comparison baseline | yes | yes | no | SDXL base 1.0 or a rights-clean SDXL card/stationery checkpoint | Pull if DreamShaper keeps creating faces, fake text, or physical-card artifacts. |
...
- `qwen3-14b-instruct`: Qwen/Qwen3-14B-GGUF, Q4_K_M. Pull Qwen3 14B if Gemma 31B is too slow for routine benchmark loops; keep Qwen3 8B as smoke-only evidence.
...
| yes | image-generation-checkpoint | 6.46 | `D:\ComfyUI-Easy-Install\ComfyUI-Easy-Install\ComfyUI\models\checkpoints\sd_xl_turbo_1.0_fp16.safetensors` | Installed image research candidate; needs a repeatable ComfyUI workflow before benchmark promotion. |
...
| no | image-generation-research | 7.22 | `D:\ComfyUI-Easy-Install\ComfyUI-Easy-Install\ComfyUI\models\diffusion_models\flux-2-klein-base-4b.safetensors` | Installed image research candidate; needs a repeatable ComfyUI workflow before benchmark promotion. |
...
| no | multimodal-projector | 0.78 | `D:\ComfyUI-Easy-Install\ComfyUI-Easy-Install\ComfyUI\models\LLM\GGUF\Qwen\Qwen3-VL-4B-Instruct-GGUF\mmproj-Qwen3VL-4B-Instruct-F16.gguf` |  |
| no | vision-language | 2.33 | `D:\ComfyUI-Easy-Install\ComfyUI-Easy-Install\ComfyUI\models\LLM\GGUF\Qwen\Qwen3-VL-4B-Instruct-GGUF\Qwen3VL-4B-Instruct-Q4_K_M.gguf` |  |
| no | multimodal-projector | 1.08 | `D:\ComfyUI-Easy-Install\ComfyUI-Easy-Install\ComfyUI\models\LLM\GGUF\Qwen\Qwen3-VL-8B-Instruct-GGUF\mmproj-Qwen3VL-8B-Instruct-F16.gguf` | Installed visual judge candidate; not yet wired into benchmark scoring. |
| no | vision-language | 4.68 | `D:\ComfyUI-Easy-Install\ComfyUI-Easy-Install\ComfyUI\models\LLM\GGUF\Qwen\Qwen3-VL-8B-Instruct-GGUF\Qwen3VL-8B-Instruct-Q4_K_M.gguf` | Installed visual judge candidate; not yet wired into benchmark scoring. |
...
| no | image-vae | 0.31 | `D:\ComfyUI-Easy-Install\ComfyUI-Easy-Install\ComfyUI\models\vae\flux2-vae.safetensors` |  |
