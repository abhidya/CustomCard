...
| `text-openai-baseline` | `openai-responses-chat` | `gpt-4o-mini` | yes | none |
| `text-gemini-baseline` | `google-gemini-chat` | `gemini-1.5-flash` | yes | none |
| `text-claude-baseline` | `anthropic-messages-chat` | `claude-3-5-haiku-latest` | yes | none |
...
| `image-openai-gpt-image-2` | `openai-images` | `gpt-image-2` | yes | none |
| `image-gemini-supported` | `google-gemini-image` | `gemini-3.1-flash-image` | yes | none |
