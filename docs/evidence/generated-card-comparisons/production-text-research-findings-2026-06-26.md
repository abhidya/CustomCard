...
| `docs/evidence/generated-card-comparisons/production-text-dry-run-20260627-production-planner` | Planned 3 runs | Wrapper dry-run proof records the full-quality local planner path: Gemma 31B at `5003`, 8192 context tokens, 3200 output tokens, `CUSTOMCARD_LOCAL_LLM_REQUEST_TIMEOUT_MS=1200000`, and the aquarium/koi/dog LLM-generated-copy matrix. This is planning proof only; it does not replace the live benchmark or manual grades. |
