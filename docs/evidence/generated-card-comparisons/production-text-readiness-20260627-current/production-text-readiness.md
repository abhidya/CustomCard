...
Created: 2026-06-27T00:28:10.486Z
Status: blocked
Promotion ready: no
...
| live ComfyUI reachable | yes | fail | {"comfyUrl":"http://127.0.0.1:8188","error":"fetch failed"} |
| live ComfyUI exposes CustomCardTextComposer | yes | fail | {"comfyUrl":"http://127.0.0.1:8188","objectInfoKeys":0} |
...
| configured production planner endpoint is reachable | yes | fail | {"configuredPlannerUrls":["http://127.0.0.1:5003/v1"],"discoveryMode":false,"activePlannerEndpoints":[{"baseUrl":"http://127.0.0.1:5003/v1","reachable":false,"activeModel":"","models":[],"smallPlanner":false,"productionSuitable":false,"error":"fetch failed"}]} |
| configured production planner endpoint is production-suitable | yes | fail | {"configuredPlannerUrls":["http://127.0.0.1:5003/v1"],"discoveryMode":false,"activePlannerEndpoints":[{"baseUrl":"http://127.0.0.1:5003/v1","reachable":false,"activeModel":"","models":[],"smallPlanner":false,"productionSuitable":false,"error":"fetch failed"}]} |
| configured production planner is not a small smoke model | yes | ok | {"configuredPlannerUrls":["http://127.0.0.1:5003/v1"],"discoveryMode":false,"activePlannerEndpoints":[{"baseUrl":"http://127.0.0.1:5003/v1","reachable":false,"activeModel":"","models":[],"smallPlanner":false,"productionSuitable":false,"error":"fetch failed"}]} |

## Planner Endpoints

| Endpoint | Reachable | Active model | Context | Output cap | Production suitable |
| --- | --- | --- | --- | --- | --- |
| http://127.0.0.1:5003/v1 | no | fetch failed | n/a | n/a | no |
...
- Start the target ComfyUI server on the configured URL.
- Install/link comfyui-custom-nodes/CustomCardTextComposer into ComfyUI/custom_nodes and restart ComfyUI.
