...
`production-text-research-rollup-20260627-production-planner/production-text-research-rollup.md`.

Current production-text evidence index:
`production-text-evidence-index-20260627-production-planner/production-text-evidence-index.md`.
...
`production-text-planner-preflight-20260627-production-planner/production-text-planner-preflight.md`.

Current production-text live Comfy preflight:
`production-text-preflight-20260627-production-planner/production-text-preflight.md`.

Current production-text readiness doctor:
`production-text-readiness-20260627-production-planner/production-text-readiness.md`.
...
`production-text-promotion-gate-20260627-production-planner/production-text-promotion-gate.md`.
