...
Created: 2026-06-27T00:28:24.656Z
Status: blocked
Promotion ready: no
...
| --- | --- | --- | --- |
| Rerun Plan | [open](../production-text-rerun-plan-20260627-current/production-text-rerun-plan.json) | rerun-required | 10 failed requirement(s); commands=10 |
| Planner | [open](../production-text-planner-preflight-20260627-current/production-text-planner-preflight.json) | blocked | production-suitable; model=koboldcpp/gemma-4-31B-it-Q4_K_M; context=8192 |
| Readiness | [open](../production-text-readiness-20260627-current/production-text-readiness.json) | blocked | 5 blocker(s); planner=none |
...
| Preflight | [open](../production-text-preflight-20260627-current/production-text-preflight.json) | failed | comfy=no node=no |
