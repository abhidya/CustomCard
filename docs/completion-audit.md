...
customer/admin/API/persistence, repository-backed relationship-memory,
render-packet, import-preview, card-project, manual-vendor-handoff, and
data-request route coverage, mobile-shell contract, CI
