...
customer/admin/API/persistence, repository-backed render-packet, import-preview,
card-project, manual-vendor-handoff, and data-request route coverage, mobile-shell contract, CI
