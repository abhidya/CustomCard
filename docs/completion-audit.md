...
customer/admin/API/persistence, repository-backed card-project route coverage,
mobile-shell contract, CI verification, and deployment-readiness expansion. The
broader active production objective remains incomplete because deployed
