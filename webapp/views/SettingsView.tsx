import { CalendarCheck, FileText, ShieldCheck, UserRound } from "lucide-react";
...
export function SettingsView({
  ...
  return (
    <>
      ...
      <div className="settings reveal reveal-1">
        ...
        <section className="panelcard settingsection" aria-label="Privacy choices">
          ...
          <div className="settingrequests">
            {privacyRequests.map((request) => (
              <div className="settingrequest" key={request.id}>
                <div>
                ...
                <button
                  ...
                  type="button"
                >
                  {pendingRequest === request.id ? "Sending..." : "Send request"}
                </button>
              </div>
            ))}
          </div>
